...
CC=		riscv64-unknown-elf-gcc			# C compiler name goes here (UNIX)
...
HZ=		1000000			# Frequency of times(2) clock ticks
...
# Files added by rer:
FILES1=		README.RER clarify.doc Makefile submit.frm
# Reinhold's files:
FILES2=		Rationale $(HDR) $(SRC)
FILES3=		dhry.p
